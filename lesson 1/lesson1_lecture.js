...
//--------------------------------------------------------------------------------------------
// console.log('Hello Odesa') // Ця команда допомогає виводити у консоль різні дані, також зауваження, що коментар може бути і посередині кода
...
//Також можемо оголошувати та ініціалізувати одночасно декілька змінних!
/* let q, w, e;
let a = 5, b = 10, c = a + b;
console.log(c) */
...
/* kebab-casing – слова-виключення такі як min-width-value, error-message, тільки пишуться через дефіс оскільки вони відносяться до CSS,
а там інші правила написання */

// let min-width-value, error-message


// Регістр має значення ! Тобто якщо ім'я змінної з маленької лутери, то воно повинно всюди буди з маленької літери
// var login;
...
//Reason 1 (Помилковий варіант)
/* let variable = 5;
{
  let variable1 = 6;
}
console.log(variable);
console.log(variable1);//variable1 cannot be used here (оскільни variable1 знаходиться в локальній області (у фігурних дужках), 
                       //а достучатися ми намагаєиогся до ньго поза локальною областю) */
...
//З var все навпаки, буде бачити і в локальній і в глобальній області
...
// Тобто до var можна достучатись будь де

//Reason 2 
/* let b =1;
let b =2;
console.log(b) */ //не можна при let надавати одинакові імена змінним (виведе помилку)

/*  var a = 1; 
var a = 2;
console.log(a) //помилку НЕ виведе, але виведе тільки останнє значення змінної, тобто 2
  */
...
//Об'єднання рядків (конкатенація). У JavaScript конкатенація виконується за допомогою оператора + і обовязково треба перед слідуючим словом 
//поставити пробіл, або після першого слов, тому що якщо не поставити, то слова будуть писатия слитно
/* let fullName = "John" + " Doe";
console.log(fullName);  */

/*  let firstName = "John";
let lastName = "Doe";
// let fullName = firstName + lastName;  (як провети конкатенацію з іменами змінних) 
let fullName = firstName + " " + lastName;
console.log(fullName);  */

//Доступ до символів в рядку (у переше чило починається з нуля , тобто 0 = перша буква слова):
/* let str = "JavaScript";
...
//Варіант 2
let text = "Anna".length
console.log(text); // Результат 4 */
...
для підстави змінних у рядок без конкатенації: */ /* ОБОВ'ЯЗКОВО шаблонні рядки треба заключати НЕ в лваки одинарні чи подвійні, 
а в в пару обратних штрів (англ розкладка де беква Ё) */ 
...
let age = 30;
console.log(`Вам ${age} років.`); //Результат : "Вам 30 років"
